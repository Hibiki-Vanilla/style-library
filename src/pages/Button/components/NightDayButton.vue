...
export default {
  ...
  methods: {
    toggle() {
      ...
      // const nightDayButton = document.querySelector("#nightDayButton");
      // if (SYNC.checked){
      //   nightDayButton.setAttribute("data-dark-mode", this.status ? false : true);
      // }
